...
REN_MAP_FIELD(DESCRIPTOR_TYPE_SAMPLED_TEXTURE,
              VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE);
REN_MAP_FIELD(DESCRIPTOR_TYPE_STORAGE_TEXTURE,
              VK_DESCRIPTOR_TYPE_STORAGE_IMAGE);
REN_MAP_FIELD(DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER,
              VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER);
REN_MAP_FIELD(DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER,
