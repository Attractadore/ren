...
auto ren::sdl2::init(const RendererDesc &desc) -> expected<void> {
...
auto ren::sdl2::create_swapchain(SDL_Window *window) -> expected<Swapchain> {
  return ren::vk::create_swapchain(
